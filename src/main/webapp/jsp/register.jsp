...
<div class="p-x-1 p-y-3 ">
 <form class="card card-block m-x-auto form-width" action="register" method="POST">
 <legend class="m-b-1 text-xs-center">Регистрация</legend>
 <div class="form-group input-group">
 <span class="has-float-label">
 <label for="first">Имя</label>
 <input class="form-control" id="first" type="text" placeholder="Имя" name="firstname"/>
 </span>
 </div>
 <div class="form-group input-group">
 <span class="has-float-label">
 <label for="last">Фамилия</label>
 <input class="form-control" id="last" type="text" placeholder="Фамилия" name="lastname"/>
 </span>
 </div>
  <div class="form-group input-group">
  <span class="has-float-label">
  <label for="last">NickName</label>
  <input class="form-control" id="last" type="text" placeholder="Nickname" name="nickName"/>
  </span>
  </div>
 <div class="form-group input-group">
 <span class="has-float-label">
 ...
 <input class="form-control" id="email" type="email" placeholder="name@example.com" name="email"/>
  ...
  <input class="form-control" id="login" type="login" name="login"/>
  </span>
  </div>
 <div class="form-group input-group">
